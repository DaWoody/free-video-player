...
var freeVideoPlayer = function(initiationObject){
    ...
    var mpdParserModule = freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser(),
        ...
        adaptiveStreamingModule = freeVideoPlayerModulesNamespace.freeVideoPlayerAdaptiveStream(settingsObject),
    ...
    var _clearVideo = function(){
        ...
        if(adaptiveStreamingModule){
            adaptiveStreamingModule.abortSourceBuffers(currentVideoStreamObject);
            adaptiveStreamingModule.clearMediaSource(that);
        }
    };
