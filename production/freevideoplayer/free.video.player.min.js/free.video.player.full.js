...
freeVideoPlayerModulesNamespace.freeVideoPlayerAdaptiveStream=function(e,t){"use strict";function r(){if(a()){var e={};e.message="Adaptive Bitrate Module - started with support for MSE",e.methodName="printOutOnStartup",e.moduleName=I,e.moduleVersion=j,L.printOutMessageToConsole(e)}else{var e={};e.message="ERROR - Adaptive Bitrate Module - Browser do not support MSE",e.methodName="printOutOnStartup",e.moduleName=I,e.moduleVersion=j,L.printOutMessageToConsole(e)}}function o(){r()}function n(e){try{console.log("Reached abort source buffers");for(var t=e.sourceBuffers,r=0,o=t.length;o>r;r++)console.log("Trying to abort source buffer stream index "+r),t[r].abort();e.sourceBuffers=[]}catch(n){var a={};a.message="Could not abort source buffers, check accessibility",a.methodName="abortSourceBuffers",a.moduleName=I,a.moduleVersion=j,L.printOutErrorMessageToConsole(a,n)}}function a(){var e=!1,t=new MediaSource||null;return t&&(e=!0),e}function s(e){var t=e.videoWrapperClassName,r=e.optionalConfigurationObject,o=e.mpdObject,n=e.hlsObject;H.streamBaseUrl=e.streamBaseUrl,o?H.mpdObject=o:e.mpdObject={},n?H.hlsObject=n:e.hlsObject={},i(),u(t),l(H.streamBaseUrl,r),b()}function i(){V._mediaSource=new MediaSource}function l(t,r){console.log("## LOADING VIDEO WITH URL "+t),H.streamBaseUrl=t,V._videoElement.src=window.URL.createObjectURL(V._mediaSource),r?V._videoElement.poster=r.videoSplashImageUrl?r.videoSplashImageUrl:e.videoSplashImageUrl:V._videoElement.poster=e.videoSplashImageUrl}function u(e){V._videoWrapper=document.querySelector("."+e);var t=document.createElement("video");V._videoElement=t,V._videoWrapper.appendChild(t)}function d(e){H.streamBaseUrl=e}function c(){return H.streamBaseUrl}function m(e){console.log("Reached _videoReady function");var t=U.returnArrayOfAdaptionSetsFromMpdObject(H.mpdObject),r=U.returnArrayOfRepresentationSetsFromAdapationSet(t[0]),o=!1,n=!1,a=(c(),[]);console.log("The adaptionsets are:"),console.log(t),console.log("The representation are:"),console.log(r),t.forEach(function(e,t,r){var s=0,i=U.returnMimeTypeFromAdaptionSet(e),l=U.returnArrayOfRepresentationSetsFromAdapationSet(e),u=i?i:U.returnMimeTypeFromRepresentation(l[s]),d=U.returnSegmentTemplateFromAdapationSet(e),c=null,m=U.returnMediaStructureAsObjectFromSegmentTemplate(d),p=U.returnMediaDurationInSecondsFromMpdObject(),b=(U.returnStartNumberFromRepresentation(l[s]),m.segmentPrefix),f=m.segmentEnding,C=U.returnAverageSegmentDurationFromMpdObject(H.mpdObject),g="",O="",S=[],y=!1,M=!1,I=!1,j=!1,E="video",L=null,B=0,R=[],A=0,P=1e3;if(u=i?i:U.returnMimeTypeFromRepresentation(l[s]),console.log("The mimeType we find is "+u),console.log("The representation sets are "),console.log(l),R=U.returnArrayOfContentComponentsFromAdaptionSet(e),A=R.length,g=U.returnCodecsFromRepresentation(l[s]),O=U.returnBaseUrlFromRepresentation(l[s]),u.indexOf("video")>-1&&0==A&&(y=!0),u.indexOf("video")>-1&&A>0&&(M=!0),u.indexOf("audio")>-1&&(I=!0),u.indexOf("vtt")>-1&&(j=!0),o||!y||j||(L=V._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),H.sourceBuffers.push(L),console.log("Adding a video stream!"),o=!0,E="video"),n||!I||j||(L=V._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),H.sourceBuffers.push(L),console.log("Adding a audio stream!"),n=!0,E="audio"),o||!M||j||(L=V._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),H.sourceBuffers.push(L),console.log("Adding a video and audio stream!"),o=!0,n=!0,E="videoAndAudio"),l.length>0){S=U.returnArrayOfBaseUrlObjectsFromArrayOfRepresentations(l);var Y=S.length,q=Y-1;console.log("Setting the highest index to"+q),console.log("The stream we have is.."+E),H.adaptiveStreamBitrateObjectMap.set(E+"_baseUrlHighestIndex",q)}else H.adaptiveStreamBitrateObjectMap.set(E+"_baseUrlHighestIndex",0);if(!j){c=U.returnInitializationFromSegmentTemplate(d);var z={};z.baseUrlObjectArray=S,z.typeOfStream=E,F(z),L.addEventListener("updatestart",function(){console.log("Should start with update... sourceBuffer.updating should be true.."+L.updating)}),L.addEventListener("update",function(){console.log("Should be done with update... sourceBuffer.updating should be false.."+L.updating)}),L.addEventListener("updateend",function(){V._videoElement.error&&console.log(V._videoElement.error),L.buffered.length>0&&console.log(u+" buffer timerange start="+L.buffered.start(0)+" / end="+L.buffered.end(0)),B++;var e=Math.round(p/C);return console.log("The amount of segments should be around.. "+e),B>e&&"open"==MediaSource.readyState?void V._mediaSource.endOfStream():(H.adaptiveStreamBitrateObjectMap.set(E+"_baseUrlObjectArray",S),O=W()?h(E):T(),void setTimeout(function(){v(L,H.streamBaseUrl+O+b+B+f,u)},P))}),console.log("source buffer "+t+" mode: "+L.mode),v(L,H.streamBaseUrl+O+c,u),a.push(L)}})}function v(e,t,r){console.log("Appending "+r+" data"),p(t,function(t){var o=new Blob([t],{type:r}),n=new FileReader;n.onload=function(t){e.appendBuffer(new Uint8Array(t.target.result))},n.readAsArrayBuffer(o)})}function p(e,t){var r=new XMLHttpRequest;r.open("GET",e,!0),r.responseType="arraybuffer",r.send(),r.onload=function(o){return 200!=r.status?(alert("Unexpected status code "+r.status+" for "+e),!1):void t(new Uint8Array(r.response))}}function b(){return V._mediaSource.addEventListener("sourceopen",m,!1),V._mediaSource.addEventListener("webkitsourceopen",m,!1),V._mediaSource.addEventListener("webkitsourceended",function(e){console.log("mediaSource readyState: "+this.readyState)},!1),V}function f(){try{V._mediaSource=null}catch(e){var t={};t.message="Could not clear mediaSource element, check accessibility in DOM",t.methodName="clearMediaSource",t.moduleName=I,t.moduleVersion=j,L.printOutErrorMessageToConsole(t,e)}return V}function C(){H=g()}function g(){var e={bitrateSwitchTimerSegmentAppendTime:0,currentVideoBitrateIndex:0,sourceBuffers:[],mpdObject:{},hlsObject:{},adaptiveStreamBitrateObjectMap:new Map,currentVideoBaseUrl:"auto",streamBaseUrl:""};return e}function h(e){var t="",r=0,o=0,n=E.get("lowest"),a=E.get("secondLowest"),s=E.get("middle"),i=E.get("highest"),l=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray");try{if(r=(new Date).getTime(),H.adaptiveStreamBitrateObjectMap.has(e+"_bitrateSwitchTimerSegmentAppendTime")||(H.adaptiveStreamBitrateObjectMap.set(e+"_bitrateSwitchTimerSegmentAppendTime",r),H.adaptiveStreamBitrateObjectMap.set(e+"_baseUrlObjectArray",l),H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)),o=r-H.adaptiveStreamBitrateObjectMap.get(e+"_bitrateSwitchTimerSegmentAppendTime"),0==o){var u=H.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)}if(n>o){console.log("Switching to highest bitrate - dl time less than "+n);var d=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlHighestIndex");t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[d].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",d)}if(o>=n&&a>o){console.log("Switching to higher bitrate - dl time less than 2500, higher than "+n);var u=H.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex"),d=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlHighestIndex");d>u?(t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u+1].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u+1)):(t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u))}if(o>=a&&s>o){console.log("Staying at this bitrate - dl time more than "+a+", less than "+s);var u=H.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u)}if(o>=s&&i>o){console.log("Switching to lower bitrate - dl time higher than "+s+" but lower than "+i);var u=H.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");u>0?(t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u-1].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u-1)):(t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u))}o>=i&&(console.log("Switching to lowest bitrate - dl time more than "+i),t=H.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[0].baseUrl,H.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)),H.adaptiveStreamBitrateObjectMap.set(e+"_bitrateSwitchTimerSegmentAppendTime",r)}catch(c){var m={};m.message="Could not parse base url from the baseUrlObjectsArray",m.methodName="_returnBaseUrlBasedOnBitrateTimeSwitch",m.moduleName=I,m.moduleVersion=j,L.printOutErrorMessageToConsole(m,c)}return t}function O(){return j}function S(){return I}function y(){return M}var V={},e=e,M=!0,I="ADAPTIVE STREAMING",j="0.9.0",E=new Map,H=g(),U=freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser(),L=freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,j),t=t||null;E.set("lowest",1500),E.set("secondLowest",2500),E.set("middle",3500),E.set("highest",6e3);var T=function(){var e=H.currentVideoBaseUrl;return e},W=function(){var e=!1;return"auto"===H.currentVideoBaseUrl&&(e=!0),e},F=function(e){var r=e.typeOfStream,o=e.baseUrlObjectArray;console.log("Ok reached this thing here.. baseUrlObejctsArray..:"),console.log(e),t&&t.addBitrateMenuToSettingsIcon(r,o)};return V.addStreamBaseUrl=d,V.clearCurrentVideoStreamObject=C,V.loadDashMediaWithMediaSourceExtension=s,V.browserSupportsMediaSource=a,V.abortSourceBuffers=n,V.clearMediaSource=f,V.getName=S,V.getVersion=O,V.isModule=y,o(),V},freeVideoPlayerModulesNamespace.freeVideoPlayerMessages=function(e,t){"use strict";function r(t,r){var o="",n=t.message,a=t.methodName,s=t.moduleName,i=t.moduleVersion;o+="====================================================\n",o+="Free Video Player Library - ERROR\n",o+="ModuleName: "+s+"\n",o+="ModuleVersion: "+i+"\n",o+="See more @: "+d+"\n",o+="Method: "+a+"\n",o+="Message: "+n+"\n",o+="====================================================\n",e.debugMode&&(console.log(o),console.log(r))}function o(t){var r="",o=t.message,n=t.methodName,a=t.moduleName,s=t.moduleVersion;r+="====================================================\n",r+="Free Video Player Library - MESSAGE\n",r+="ModuleName: "+a+"\n",r+="ModuleVersion: "+s+"\n",r+="See more @: "+d+"\n",r+="Method: "+n+"\n",r+="Message: "+o+"\n",r+="====================================================\n",e.debugMode&&console.log(r)}function n(){return t}function a(){return l}function s(){return u}var i={},l="MESSAGES",u=!0,t=t,d="http://www.freevideoplayer.org";return i.printOutErrorMessageToConsole=r,i.printOutMessageToConsole=o,i.getVersion=n,i.getName=a,i.isModule=s,i},freeVideoPlayerModulesNamespace.freeVideoPlayerControls=function(e,t,r){"use strict";function o(r,o){var r=r,a=r.getElementsByTagName("div")[0]||null,s=r.getElementsByTagName("video")[0]||null,l=parseInt(e.videoControlsVolumeTresholdValues.volumeHighStart,10),u=parseInt(e.videoControlsVolumeTresholdValues.volumeLowEnd,10),S=document.createElement("div"),y=o.mediaType||"static";S.setAttribute("data-video-player-control","wrapper"),S.setAttribute("class",e.videoControlsCssClasses.videoControlsClass),k.currentVideoObject=o,k.videoWrapper=r,k.videoElement=s,k.currentVideoControlsObject={volumeHighStart:l,volumeLowEnd:u},a&&(r.removeChild(a),L(),k.currentVideoControlsObject={});var V=document.createElement("div"),M=document.createElement("div"),I=document.createElement("div"),j=document.createElement("input"),E=document.createElement("div"),H=document.createElement("input"),T=document.createElement("div"),W=document.createElement("span"),F=document.createElement("span"),B=document.createElement("div"),A=document.createElement("div"),P=document.createElement("div"),Y=document.createElement("div"),q=document.createElement("div"),z=document.createElement("div"),X=document.createElement("div"),x=document.createElement("div");k.currentVideoControlsObject.playButton=V,k.currentVideoControlsObject.volumeIcon=M,k.currentVideoControlsObject.fullScreenButton=I,k.currentVideoControlsObject.progressSlider=j,k.currentVideoControlsObject.volumeSliderContainer=E,k.currentVideoControlsObject.volumeSlider=H,k.currentVideoControlsObject.progressTimerContainer=T,k.currentVideoControlsObject.progressTimerCurrentTime=W,k.currentVideoControlsObject.progressTimerTotalDuration=F,k.currentVideoControlsObject.videoOverlayPlayPauseIcon=B,k.currentVideoControlsObject.videoOverlaySpinnerIcon=A,k.currentVideoControlsObject.controlsWrapper=S,k.currentVideoControlsObject.settingsIcon=P,k.currentVideoControlsObject.settingsMenu=Y,k.currentVideoControlsObject.subtitlesContainer=z,k.currentVideoControlsObject.bitrateButton=X,k.currentVideoControlsObject.videoFormatContainer=q,k.currentVideoControlsObject.liveIcon=x,o.progressSlider=j,V.setAttribute("class",e.videoControlsCssClasses.playpauseContainerClass),j.setAttribute("class",e.videoControlsCssClasses.progressbarContainerClass),E.setAttribute("class",e.videoControlsCssClasses.volumeContainerClass),M.setAttribute("class",e.videoControlsCssClasses.volumeIconClass),z.setAttribute("class",e.videoControlsCssClasses.subtitlesMenuContainerClass),I.setAttribute("class",e.videoControlsCssClasses.fullscreenContainerClass),T.setAttribute("class",e.videoControlsCssClasses.progressTimerContainerClass),B.setAttribute("class",e.videoControlsCssClasses.videoOverlayPlayPauseIconClass),A.setAttribute("class",e.videoControlsCssClasses.videoOverlaySpinnerIconClass),P.setAttribute("class",e.videoControlsCssClasses.settingsIconClass),Y.setAttribute("class",e.videoControlsCssClasses.settingsMenuClass+" "+e.videoControlsCssClasses.displayNoneClass),q.setAttribute("class",e.videoControlsCssClasses.videoFormatContainerClass),x.setAttribute("class",e.videoControlsCssClasses.liveIconClass),H.setAttribute("type","range"),H.setAttribute("value",100),H.setAttribute("orient","vertical"),j.setAttribute("type","range"),j.setAttribute("value",0),V.setAttribute("data-"+t+"-control-type","playpause"),M.setAttribute("data-"+t+"-control-type","mute"),z.setAttribute("data-"+t+"-control-type","subtitles"),I.setAttribute("data-"+t+"-control-type","fullscreen"),T.setAttribute("data-"+t+"-control-type","progress-timer"),j.setAttribute("data-"+t+"-control-type","progress"),H.setAttribute("data-"+t+"-control-type","volume"),B.setAttribute("data-"+t+"-control-type","video-overlay-play-pause"),A.setAttribute("data-"+t+"-control-type","video-overlay-spinner"),P.setAttribute("data-"+t+"-control-type","settings"),V.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml,M.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml,I.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml,z.innerHTML=e.videoControlsInnerHtml.subtitlesMenuInnerHtml,P.innerHTML=e.videoControlsInnerHtml.settingsIconInnerHtml,W.innerHTML="0:00",q.innerHTML=e.videoControlsInnerHtml.videoFormatContainerInnerHtml,x.innerHTML=e.videoControlsInnerHtml.liveIconInnerHtml,B.addEventListener("click",i),V.addEventListener("click",i),I.addEventListener("click",O),j.addEventListener("change",p),j.addEventListener("mousedown",c),j.addEventListener("mouseup",d),M.addEventListener("click",v),M.addEventListener("mouseover",C),M.addEventListener("mouseout",g),E.addEventListener("mouseout",g),H.addEventListener("change",m),P.addEventListener("click",h),s.addEventListener("loadedmetadata",f),s.addEventListener("timeupdate",b);var w=R(s);w&&z.addEventListener("click",function(e){w.style.display="block"===w.style.display?"none":"block"}),T.appendChild(W),T.appendChild(F),q=n(q),Y.appendChild(q),E.appendChild(H),o.volumeSliderContainer=E,e.videoControlsDisplay.showProgressSlider&&"static"===y&&S.appendChild(j),e.videoControlsDisplay.showPlayPauseButton&&S.appendChild(V),e.videoControlsDisplay.showVolumeIcon&&(M.appendChild(E),S.appendChild(M)),e.videoControlsDisplay.showVolumeSlider,w&&e.videoControlsDisplay.showSubtitlesMenu&&(z.appendChild(w),Y.appendChild(z)),e.videoControlsDisplay.showSettingsIcon&&S.appendChild(P),e.videoControlsDisplay.showTimer&&"static"===y&&S.appendChild(T),e.videoControlsDisplay.showFullScreenButton&&S.appendChild(I),"static"!==y&&r.appendChild(x),P.appendChild(Y),r.appendChild(A),r.appendChild(B),r.appendChild(S),U()}function n(e){var t=k.currentVideoObject.videoFormat,r=document.createElement("span");return r.innerHTML=t,e.appendChild(r),e}function a(r,o){if(console.log("_addBitrateMenuToSettingsIcon - The stream is.."+r),"audio"!==r){var n=document.createElement("div"),a=document.createElement("ul"),i=o.length;n.innerHTML=e.videoControlsInnerHtml.bitrateQualityMenuInnerHtml,n.setAttribute("class",e.videoControlsCssClasses.bitrateQualityMenuContainerClass),n.setAttribute("data-"+t+"-control-type","quality"),a.setAttribute("class",e.videoControlsCssClasses.bitrateQualityMenuClass);for(var l=0;i>l;l++){var u=document.createElement("li");u.setAttribute("data-"+t+"-bitrate-index",o[l].index),u.setAttribute("data-"+t+"-bitrate-base-url",o[l].baseUrl),u.setAttribute("data-"+t+"-state","inactive"),u.innerHTML=o[l].height+"p",u.addEventListener("click",s),a.appendChild(u)}if(i>0){var u=document.createElement("li");u.setAttribute("data-"+t+"-bitrate-index","auto"),u.setAttribute("data-"+t+"-bitrate-base-url","auto"),u.setAttribute("data-"+t+"-state","active"),u.innerHTML="auto",u.addEventListener("click",s),a.appendChild(u)}n.appendChild(a),k.currentVideoControlsObject.settingsMenu.appendChild(n)}}function s(){for(var e=this.nodeName,r=this.getAttribute("data-"+t+"-bitrate-base-url"),o=this.parentNode,n=o.getElementsByTagName(e),a=0,s=n.length;s>a;a++)n[a].setAttribute("data-"+t+"-state","inactive");this.setAttribute("data-"+t+"-state","active"),console.log("Hey clicked videoBitrate.."),console.log("Consoling out the buttion?"),console.log(this),console.log("The base url is..."+r),k.currentVideoObject.currentVideoBaseUrl=r}function i(){k.currentVideoObject.playing?(k.videoElement.pause(),l(),V(),k.currentVideoObject.playing=!1):(k.videoElement.play(),u(),y(),k.currentVideoObject.playing=!0)}function l(){k.currentVideoControlsObject.playButton.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml}function u(){k.currentVideoControlsObject.playButton.innerHTML=e.videoControlsInnerHtml.pauseIconInnerHtml}function d(){k.currentVideoObject.playing?(k.videoElement.play(),u(),k.currentVideoObject.playing=!0):(c(),k.currentVideoObject.playing=!1)}function c(){k.videoElement.pause(),l()}function m(){var t=0;k.currentVideoControlsObject.volumeSlider.value>=k.currentVideoControlsObject.volumeHighStart?k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml:k.currentVideoControlsObject.volumeSlider.value<k.currentVideoControlsObject.volumeHighStart&&k.currentVideoControlsObject.volumeSlider.value>k.currentVideoControlsObject.volumeLowEnd?k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeLowIconInnerHtml:k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml,k.currentVideoControlsObject.volumeIcon.appendChild(k.currentVideoObject.volumeSliderContainer),t=k.currentVideoControlsObject.volumeSlider.value/100,k.videoElement.volume=t,k.currentVideoObject.muted=!1,k.currentVideoObject.volumeSliderContainer.style.visibility="hidden"}function v(){k.currentVideoObject.muted?(k.videoElement.volume=k.currentVideoObject.volumeBeforeMute,k.currentVideoControlsObject.volumeSlider.value=100*k.currentVideoObject.volumeBeforeMute,k.currentVideoObject.muted=!1,k.currentVideoControlsObject.volumeSlider.value>=k.currentVideoControlsObject.volumeHighStart?(k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml,k.currentVideoControlsObject.volumeIcon.appendChild(k.currentVideoObject.volumeSliderContainer)):k.currentVideoControlsObject.volumeSlider.value>k.currentVideoControlsObject.volumeLowEnd&&k.currentVideoControlsObject.volumeSlider.value<k.currentVideoControlsObject.volumeHighStart?(k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeLowIconInnerHtml,k.currentVideoControlsObject.volumeIcon.appendChild(k.currentVideoObject.volumeSliderContainer)):(k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml,k.currentVideoControlsObject.volumeIcon.appendChild(k.currentVideoObject.volumeSliderContainer))):(k.currentVideoObject.volumeBeforeMute=k.currentVideoControlsObject.volumeSlider.value/100,k.videoElement.volume=0,k.currentVideoControlsObject.volumeSlider.value=0,k.currentVideoObject.muted=!0,k.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml)}function p(){var e=k.currentVideoObject.mediaDurationInSeconds,t=Math.floor(k.currentVideoControlsObject.progressSlider.value/100*e);k.videoElement.currentTime=t,console.log("The current video object playing is..."+k.currentVideoObject.playing),k.currentVideoObject.playing||c()}function b(){var e=k.currentVideoObject.mediaDurationInSeconds,t=k.videoElement.currentTime,r=Math.round(t/e*100);k.currentVideoControlsObject.progressTimerCurrentTime.innerHTML=B(t),k.currentVideoControlsObject.progressSlider.value=r}function f(){k.currentVideoControlsObject.progressTimerTotalDuration.innerHTML="/"+B(k.currentVideoObject.mediaDurationInSeconds)}function C(){k.currentVideoControlsObject.volumeSliderContainer.style.visibility="visible"}function g(){k.currentVideoControlsObject.volumeSliderContainer.style.visibility="hidden"}function h(){H(k.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass)?E(k.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass):j(k.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass)}function O(){S()?(document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen?document.webkitCancelFullScreen():document.msExitFullscreen&&document.msExitFullscreen(),k.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml):(k.videoElement.requestFullscreen?k.videoElement.requestFullscreen():k.videoElement.mozRequestFullScreen?k.videoElement.mozRequestFullScreen():k.videoElement.webkitRequestFullScreen?k.videoElement.webkitRequestFullScreen():k.videoElement.msRequestFullscreen&&k.videoElement.msRequestFullscreen(),k.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenCompressIconInnerHtml)}function S(){return!!(document.fullScreen||document.webkitIsFullScreen||document.mozFullScreen||document.msFullscreenElement||document.fullscreenElement)}function y(){E(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),k.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml,j(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function V(){E(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),k.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.pauseIconInnerHtml,j(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function M(){E(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),k.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.spinnerIconInnerHtml}function I(){E(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),k.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.spinnerIconInnerHtml,j(k.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function j(e,t){var o=e.getAttribute("class");o=o+" "+t;try{setTimeout(function(){e.setAttribute("class",o)},D.videoOverlayFadeOutDelay)}catch(n){var a={};a.message="Could not add css class to element and return after small delay",a.methodName="_addCssClassToElementAndReturn",a.moduleName=G,a.moduleVersion=K,r.printOutMessageToConsole(a)}}function E(e,t){var r=e.getAttribute("class");r=r.split(t),r.length>0&&(r=r[0].trim()),e.setAttribute("class",r)}function H(e,t){var r=e.getAttribute("class"),o=!1;return r=r.split(t),r.length>1&&(o=!0),o}function U(){T()}function L(){W()}function T(){document.addEventListener("keypress",F)}function W(){try{document.removeEventListener("keypress",F)}catch(e){var t={};t.message="Could not remove play/pause spacebar or esc eventlistener",t.methodName="_removePlayPauseSpaceBarListener",t.moduleName=G,t.moduleVersion=K,r.printOutMessageToConsole(t)}}function F(t){var r;t.keyCode?r=t.keyCode:t.which&&(r=t.which),console.log("The keyboard code is "+r),(32===r||0===r)&&(t.preventDefault(),i()),27===r&&(t.preventDefault(),S()?k.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml:k.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenCompressIconInnerHtml)}function B(e){var t="0:00";try{var o=Math.round(parseInt(e,10)),n=Math.floor(o/60),a=Math.floor(o/3600),e=o-60*n;0==a&&(a=""),10>a&&a>0&&(a="0"+a+":"),a>=10&&(a+=":"),10>e&&(e="0"+e),t=a+n+":"+e}catch(s){var i={};i.message="Could not parse and return hours, minutes, seconds string from seconds",i.methodName="returnHoursMinutesSecondsFromSeconds",i.moduleName=G,i.moduleVersion=K,r.printOutErrorMessageToConsole(i,s)}return t}function R(t){var o,n=null,a={};try{if(t.textTracks.length>0){n=document.createElement("div"),n.innerHTML=e.videoControlsInnerHtml.subtitlesMenuInnerHtml,o=document.createDocumentFragment(),n=o.appendChild(document.createElement("ul")),n.className=e.videoControlsCssClasses.subtitlesMenuClass,k.currentVideoObject.subtitlesMenu=n,a={language:e.videoControlsInnerHtml.subtitlesMenuOffButtonInnerHtml,label:e.videoControlsInnerHtml.subtitlesMenuOffButtonInnerHtml,videoElement:t},t.setAttribute("crossorigin","anonymous"),n.appendChild(A(a));for(var s=0;s<t.textTracks.length;s++){var a={language:t.textTracks[s].language,label:t.textTracks[s].label,videoElement:t};n.appendChild(A(a))}}}catch(i){var l={};l.message="Could not create a subtitles menu and return the menu",l.methodName="_createSubtitlesMenuAndReturnMenu",l.moduleName=G,l.moduleVersion=K,r.printOutErrorMessageToConsole(l,i)}return n}function A(o){var n=o.language,a=o.label,s=o.videoElement,i=s.textTracks,l=document.createElement("li"),u=l.appendChild(document.createElement("div"));return u.className=e.videoControlsCssClasses.subtitleButtonClass,n.length>0&&(u.setAttribute("lang",n),u.value=a,u.setAttribute("data-"+t+"-state","inactive"),u.appendChild(document.createTextNode(a)),u.addEventListener("click",function(e){console.log("Activating the subtitle with label "+a);try{for(var o=k.currentVideoObject.subtitlesMenu,n=o.children,s=0,l=n.length;l>s;s++)n[s].setAttribute("data-"+t+"-state","inactive");for(var u=0,d=i.length;d>u;u++)i[u].label===a?(i[u].mode="showing",this.setAttribute("data-"+t+"-state","active")):i[u].mode="hidden";o.style.display="none"}catch(c){var m={};m.message="Could not activate subtitle with language",m.methodName="_createSubtitlesMenuItem",m.moduleName=G,m.moduleVersion=K,r.printOutErrorMessageToConsole(m,c)}})),u}function P(e,t){e.forEach(function(e,r,o){var n=document.createElement("track"),a="";n.src=e.subtitleUrl,n.srclang=e.subtitleLanguage,n.setAttribute("kind","subtitles"),a=Y(e.subtitleLabel),a=q(a),n.setAttribute("label",a),n.setAttribute("data-video-player-subtitle-index",r+1),t.appendChild(n)})}function Y(e){var t=e;try{t=t.split(",")[0]}catch(o){var n={};n.message="Could not parse through the subtitle label and return the first word",n.methodName="_returnFirstWordFromSubtitleLabel",n.moduleName=G,n.moduleVersion=K,r.printOutErrorMessageToConsole(n,o)}return t}function q(e){var t=e;try{t.trim(),t=t.charAt(0).toUpperCase()+t.slice(1)}catch(o){var n={};n.message="Could not parse and Capitalize the subtitle label",n.methodName="_returnSubtitleLabelCapitalized",n.moduleName=G,n.moduleVersion=K,r.printOutErrorMessageToConsole(n,o)}return t}function z(e,t){try{for(var o="",n=0,a=e.length;a>n;n++){o=e[n].subtitleLanguage;for(var s=0,i=t.length;i>s;s++)o==t[s].language&&(e[n].subtitleLabel=t[s].label)}}catch(l){var u={};u.message="Could not modify the array of subtitles with labels, check access to subtitles array and the language object array",u.methodName="_returnModifiedArrayOfSubtitlesWithLabel",u.moduleName=G,u.moduleVersion=K,r.printOutErrorMessageToConsole(u,l)}return e}function X(){return K}function x(){return G}function w(){return N}var k={},e=e,N=!0,K="0.9.0",G="VIDEO CONTROLS",D={videoOverlayFadeOutDelay:100},t=t,r=r||freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,K);return k.createVideoControls=o,k.addSubtitlesTracksToDom=P,k.returnModifiedArrayOfSubtitlesWithLabel=z,k.addSpinnerIconToVideoOverlay=M,k.removeSpinnerIconFromVideoOverlay=I,k.addBitrateMenuToSettingsIcon=a,k.getName=x,k.getVersion=X,k.isModule=w,k},freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser=function(e,t){"use strict";function r(e){var r="static";try{r=e?e._type||"static":L.mpdObject._type||"static"}catch(o){var n={};n.message="Could not retrieve media type from the MPD",n.methodName="returnMediaTypeFromMpdObject",n.moduleName=B,n.moduleVersion=W,t.printOutErrorMessageToConsole(n,o)}return r}function o(e){var r=0,o=null;try{o=e?e._maxSegmentDuration||"M10.000S":L.mpdObject._maxSegmentDuration||"M10.000S",r=o.split("M")[1],r=r.split("S")[0]}catch(n){var a={};a.message="Could not generate a max segment duration string from the MPD",a.methodName="returnMaxSegmentDurationFromMpdObject",a.moduleName=B,a.moduleVersion=W,t.printOutErrorMessageToConsole(a,n)}return r}function n(e){var r=0,o="",n="";try{o=e?e._mediaPresentationDuration:L.mpdObject._mediaPresentationDuration,o.split("T").length>1&&(console.log("YYT"),n=o.split("T")[1]);var a=n.split("H")[0],s=n.split("H")[1].split("M")[0],i=n.split("M")[1].split("S")[0],l=parseInt(a,10),u=parseInt(s,10),d=parseInt(i,10),c=3600*l,m=60*u;r=c+m+d}catch(v){var p={};p.message="Could not get media duration string from the MPD",p.methodName="returnMediaDurationInSecondsFromMpdObject",p.moduleName=B,p.moduleVersion=W,t.printOutErrorMessageToConsole(p,v)}return r}function a(e){var r=0,o="";try{o=e?e._maxSegmentDuration||"M10S":L.mpdObject._maxSegmentDuration||"M10S",r=o.split("M")[1],r=r.split("S")[0],r=parseInt(r,10)}catch(n){var a={};a.message="Could not generate a max segment duration string from the MPD",a.methodName="returnAverageSegmentDurationFromMpdObject",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function s(e){var r=[],o=[];try{e=e||L.mpdObject,o=e.Period.AdaptationSet,"[object Array]"===Object.prototype.toString.call(o)?r=o:r.push(o)}catch(n){var a={};a.message="Could not parse mdpObject.Period.AdapationSet",a.methodName="returnArrayOfAdaptionSetsFromMpdObject",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function i(e){var r=s(e),o=[],n={},a="",i=1;try{r.forEach(function(e,t,r){var s=c(e);if(n=s[0],a=p(n),a.indexOf("vtt")>-1){var l={};l.subtitleUrl=v(n),l.subtitleLanguage=d(e),l.subtitleId=i,i++,o.push(l)}})}catch(l){var u={};u.message="Could not return array of subtitles, check method",u.methodName="returnArrayOfSubtitlesFromMpdObject",u.moduleName=B,t.printOutErrorMessageToConsole(u,l)}return o}function l(e){var r={};try{r=e.SegmentTemplate}catch(o){var n={};n.message="Could not parse SegmentTemplate from AdapationSet",n.methodName="returnSegmentTemplateFromAdapationSet",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r;
}function u(e){var r=null;try{r=e._mimeType?e._mimeType:null}catch(o){var n={};n.message="Could not return MimeType from AdaptionSet",n.methodName="returnMimeTypeFromAdaptionSet",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function d(e){var r="";try{r=e._lang}catch(o){var n={};n.message="Could not parse Subtitle track url from AdapationSet",n.methodName="returnSubtitleUrlFromAdapationSet",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function c(e){var r=[],o=[];try{o=e.Representation,"[object Array]"===Object.prototype.toString.call(o)?r=o:r.push(o)}catch(n){var a={};a.message="Could not parse and return an array of Representation from AdapationSet, check input",a.methodName="returnArrayOfRepresentationFromAdapationSet",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function m(e){var r=[],o=[];try{o=e.ContentComponent,"[object Array]"===Object.prototype.toString.call(o)&&(r=o)}catch(n){var a={};a.message="Could not parse and return an array of ContentComponents from AdapationSet, check input",a.methodName="returnArrayOfContentComponentsFromAdaptionSet",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function v(e){var r="";try{r=e.BaseURL}catch(o){var n={};n.message="Could not parse BaseURL from Representation",n.methodName="returnBaseUrlFromRepresentation",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function p(e){var r="";try{r=e._mimeType}catch(o){var n={};n.message="Could not return MimeType from Representation",n.methodName="returnMimeTypeFromRepresentation",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function b(e){var r="";try{r=e._codecs}catch(o){var n={};n.message="Could not return Codecs from Representation",n.methodName="returnCodecsFromRepresentation",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function f(e){var r=0;try{r=e._startWithSAP}catch(o){var n={};n.message="Could not parse mpdObject and retrieve Representation._startWithSAP",n.methodName="returnStartNumberFromRepresentation",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function C(e){var r=[];try{for(var o=0,n=e.length;n>o;o++){var a={};a.bandwidth=e[o]._bandwidth,a.mimeType=e[o]._mimeType,a.codecs=e[o]._codecs,a.baseUrl=e[o].BaseURL,a.width=e[o]._width||"",a.height=e[o]._height||"",a.type=y(e[o]._mimeType,e[o]._codecs),a.index=o,r.push(a)}}catch(s){var i={};i.message="Could not parse and extract the array of base urls from the array of representations, checkt input",i.methodName="returnArrayOfBaseUrlsFromArrayOfRepresentations",i.moduleName=B,t.printOutErrorMessageToConsole(i,s)}return r}function g(e){var r=0;try{r=e._duration}catch(o){var n={};n.message="Could not parse Duration from SegmentTemplate",n.methodName="returnDurationFromSegmentTemplate",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function h(e){var r="";try{r=e._initialization}catch(o){var n={};n.message="Could not parse initializationFile from SegmentTemplate",n.methodName="returnInitializationFromSegmentTemplate",n.moduleName=B,t.printOutErrorMessageToConsole(n,o)}return r}function O(e){var r={};try{var o=e._media,o=o.split("$Number$");r.segmentPrefix=o[0],r.segmentEnding=o[1]}catch(n){var a={};a.message="Could not return media structure from SegmentTemplate",a.methodName="returnMediaStructureAsObjectFromSegmentTemplate",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function S(e,t){var r=new XMLHttpRequest;r.open("GET",e,!0),r.send(),r.onload=function(o){return 200!=r.status?(alert("Unexpected status code "+r.status+" for "+e),!1):void t(r.response)}}function y(e,r){var o="audio",n=[],a=[];try{n=r.split(","),a=e.split("video"),n.length>1&&(o="video"),a.length>1&&(o="video")}catch(s){var i={};i.message="Could not parse and return type (video or audio) from mimeType, check input",i.methodName="returnTypeFromMimeType",i.moduleName=B,t.printOutErrorMessageToConsole(i,s)}return o}function V(e){L.mpdObject=e}function M(){return L.mpdObject}function I(e){var r="",o="",n="";try{n=e.split("/"),n=n.pop(),o=e.split(n)[0],r=o}catch(a){var s={};s.message="Could not generate the streamBaseUrl from the mpdUrl",s.methodName="returnStreamBaseUrlFromMpdUrl",s.moduleName=B,t.printOutErrorMessageToConsole(s,a)}return r}function j(e){var r=!0,o=[];try{o=e.Representation,"[object Array]"===Object.prototype.toString.call(o)&&(r=!1)}catch(n){var a={};a.message="Could not parse through the AdaptionSet",a.methodName="checkIfAdapationSetContainSingleRepresentation",a.moduleName=B,t.printOutErrorMessageToConsole(a,n)}return r}function E(){return W}function H(){return B}function U(){return F}var L={},T={},W="0.9.0",F=!0,B="MPD PARSER",R={debugMode:!0},e=Object.assign({},R,e),t=t||freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,W);return T.getMpd=S,T.getMpdObject=M,T.setMpdObject=V,T.getVersion=E,T.getName=H,T.isModule=U,T.checkIfAdapationSetContainSingleRepresentation=j,T.returnStreamBaseUrlFromMpdUrl=I,T.returnTypeFromMimeTypeAndCodecString=y,T.returnMimeTypeFromAdaptionSet=u,T.returnSegmentTemplateFromAdapationSet=l,T.returnArrayOfRepresentationSetsFromAdapationSet=c,T.returnSubtitleLanguageFromAdaptionSet=d,T.returnArrayOfContentComponentsFromAdaptionSet=m,T.returnMediaTypeFromMpdObject=r,T.returnMaxSegmentDurationFromMpdObject=o,T.returnAverageSegmentDurationFromMpdObject=a,T.returnMediaDurationInSecondsFromMpdObject=n,T.returnArrayOfAdaptionSetsFromMpdObject=s,T.returnArrayOfSubtitlesFromMpdObject=i,T.returnDurationFromSegmentTemplate=g,T.returnInitializationFromSegmentTemplate=h,T.returnMediaStructureAsObjectFromSegmentTemplate=O,T.returnBaseUrlFromRepresentation=v,T.returnCodecsFromRepresentation=b,T.returnStartNumberFromRepresentation=f,T.returnMimeTypeFromRepresentation=p,T.returnArrayOfBaseUrlObjectsFromArrayOfRepresentations=C,T};var freeVideoPlayer=function(e){"use strict";var t={},r="Free Video Player",o=!1,n="0.9.0",a="free-video-player",s=freeVideoPlayerModulesNamespace.freeVideoPlayerDefaultSplashImage,i=new X2JS,l={videoWrapperClassName:"js-"+a+"-container",videoWrapperBackgroundColor:"#292c3c",videoSplashImageUrl:s,iso6391Url:"/js/freevideoplayer/subtitles/iso-639-1.json",videoControlsInnerHtml:{playIconInnerHtml:'<i class="fa fa-play"></i>',pauseIconInnerHtml:'<i class="fa fa-pause"></i>',stopIconInnerHtml:'<i class="fa fa-stop"></i>',volumeHighIconInnerHtml:'<i class="fa fa-volume-up"></i>',volumeLowIconInnerHtml:'<i class="fa fa-volume-down"></i>',novolumeIconInnerHtml:'<i class="fa fa-volume-off"></i>',fullscreenExpandIconInnerHtml:'<i class="fa fa-expand"></i>',fullscreenCompressIconInnerHtml:'<i class="fa fa-compress"></i>',spinnerIconInnerHtml:'<i class="fa fa-spinner fa-spin"></i>',settingsIconInnerHtml:'<i class="fa fa-cog"></i>',liveIconInnerHtml:'<i class="fa fa-circle"></i> LIVE',videoFormatContainerInnerHtml:"format: ",subtitlesMenuInnerHtml:"subtitles",bitrateQualityMenuInnerHtml:"quality",subtitlesMenuOffButtonInnerHtml:"Off"},videoControlsCssClasses:{videoControlsClass:a+"-controls",hideControlClass:a+"-controls-hide",displayControlClass:a+"-controls-display",videoFullScreenClass:a+"-controls-fullscreen",playpauseContainerClass:a+"-controls-playpause",progressbarContainerClass:a+"-controls-progress",progressTimerContainerClass:a+"-controls-progress-timer",volumeContainerClass:a+"-controls-volume",volumeIconClass:a+"-controls-volume-icon",fullscreenContainerClass:a+"-controls-fullscreen",hideVideoOverlayClass:a+"-controls-overlay-hide",showVideoOverlayClass:a+"-controls-overlay-show",settingsIconClass:a+"-controls-settings-icon",subtitlesMenuContainerClass:a+"-controls-subtitles-container",settingsMenuClass:a+"-controls-settings-menu",subtitlesMenuClass:a+"-controls-subtitles-menu",subtitleButtonClass:a+"-controls-subtitles-button",bitrateQualityMenuContainerClass:a+"-controls-bitrate-quality-menu-container",bitrateQualityMenuClass:a+"-controls-bitrate-quality-menu",liveIconClass:a+"-controls-live-icon",videoFormatContainerClass:a+"-controls-video-format",videoOverlayPlayPauseIconClass:a+"-controls-overlay-play-pause-icon",videoOverlaySpinnerIconClass:a+"-controls-overlay-spinner-icon",displayNoneClass:a+"-controls-display-none"},videoControlsDisplay:{showPlayPauseButton:!0,showProgressSlider:!0,showVolumeIcon:!0,showVolumeSlider:!0,showSubtitlesMenu:!0,showSettingsIcon:!0,showTimer:!0,showFullScreenButton:!0},videoControlsVolumeTresholdValues:{volumeHighStart:40,volumeLowEnd:10},debugMode:!0,createControls:!0},u=Object.assign({},l,e),d=u.videoWrapperClassName,c={subtitleLanguageObject:[]},m={mpdObject:{},adaptiveStream:!1,adaptionSets:[],subtitleTracksArray:[],subtitleMenuItems:[],playing:!1,fullScreen:!1,muted:!1,volumeBeforeMute:1,adaptiveStreamBitrateObjectMap:new Map,currentVideoBaseUrl:"auto"},v=freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(u,n),p=freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser(),b=freeVideoPlayerModulesNamespace.freeVideoPlayerControls(u,a),f=freeVideoPlayerModulesNamespace.freeVideoPlayerAdaptiveStream(u,b),C=function(e,o){var n=T(e);switch(B(),t._videoWrapper=document.querySelector("."+d),t._videoWrapper.setAttribute("style","background:"+u.videoWrapperBackgroundColor+";"),n){case"mp4":g(e,"mp4",o);break;case"ogg":g(e,"ogg",o);break;case"webm":g(e,"webm",o);break;case"dash":h(e,o);break;case"hls":break;default:var a={};a.message="The provided media url does not seem to be valid, check input",a.methodName="load",a.moduleName=r,v.printOutErrorMessageToConsole(a)}},g=function(e,o,n){try{m.adaptiveStream=!1,m.mediaType="static";var a=document.createElement("video"),s=document.createElement("source");"mp4"===o&&s.setAttribute("type","video/mp4"),"ogg"===o&&s.setAttribute("type","video/ogg"),"webm"===o&&s.setAttribute("type","video/webm"),s.setAttribute("src",e),a.appendChild(s),t._videoElement=a,n?t._videoElement.poster=n.videoSplashImageUrl?n.videoSplashImageUrl:u.videoSplashImageUrl:t._videoElement.poster=u.videoSplashImageUrl,t._videoElement.addEventListener("durationchange",function(){m.mediaDurationInSeconds=t._videoElement.duration}),t._videoWrapper.appendChild(a),m.videoFormat=o,u.createControls&&b.createVideoControls(t._videoWrapper,m)}catch(i){var l={};l.message="Could not create and load non-adaptive-video stream, check input type and videoUrl",l.methodName="loadNonAdaptiveVideo",l.moduleName=r,v.printOutErrorMessageToConsole(l,i)}},h=function(e,o){var a={};console.log("Reached here.."),p.getMpd(e,function(s){try{m.adaptiveStream=!0,a=i.xml_str2json(s),console.log("MPD"),console.log(a.MPD);var l=a.MPD;p.setMpdObject(a.MPD),m.mediaType=p.returnMediaTypeFromMpdObject(l),m.averageSegmentDuration=p.returnAverageSegmentDurationFromMpdObject(l),m.maxSegmentDuration=p.returnMaxSegmentDurationFromMpdObject(l),m.mediaDurationInSeconds=p.returnMediaDurationInSecondsFromMpdObject(l),m.videoFormat="dash";var C=p.returnStreamBaseUrlFromMpdUrl(e);console.log("The stream base url is.."+C);var g=p.returnArrayOfSubtitlesFromMpdObject(l);m.subtitleTracksArray=b.returnModifiedArrayOfSubtitlesWithLabel(g,c.subtitleLanguageObject);var h={streamBaseUrl:C,videoWrapperClassName:d,mpdObject:l,optionalConfigurationObject:o};f.loadDashMediaWithMediaSourceExtension(h),b.addSubtitlesTracksToDom(m.subtitleTracksArray,t._videoElement),console.log("Current Video Object"),console.log(m),u.createControls&&b.createVideoControls(t._videoWrapper,m)}catch(O){var S={};S.message="Could not parse input to object from xml, for the loadMpd request, check input to the xml2json library",S.methodName="loadMpd",S.moduleName=r,S.moduleVersion=n,v.printOutErrorMessageToConsole(S,O)}})},O=function(){return m.subtitleTracksArray},S=function(e){var t=new XMLHttpRequest,r=u.iso6391Url;t.open("GET",r,!0),t.responseType="application/json",t.send(),t.onload=function(o){return 200!=t.status?(alert("Unexpected status code "+t.status+" for "+r),!1):void e(t.response)}},y=function(){t._videoElement.pause()},V=function(){t._videoElement.play()},M=function(){I()?document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen?document.webkitCancelFullScreen():document.msExitFullscreen&&document.msExitFullscreen():t._videoElement.requestFullscreen?t._videoElement.requestFullscreen():t._videoElement.mozRequestFullScreen?t._videoElement.mozRequestFullScreen():t._videoElement.webkitRequestFullScreen?t._videoElement.webkitRequestFullScreen():t._videoElement.msRequestFullscreen&&t._videoElement.msRequestFullscreen()},I=function(){return!!(document.fullScreen||document.webkitIsFullScreen||document.mozFullScreen||document.msFullscreenElement||document.fullscreenElement)},j=function(e){try{t._videoElement.currentTime=e}catch(o){var n={};n.message="Could not seek to position, check that input is number",n.methodName="seek",n.moduleName=r,v.printOutErrorMessageToConsole(n,o)}},E=function(e){try{t._videoElement.volume=e}catch(o){var n={};n.message="Could not set volume, check that input is number from 0 to 1",n.methodName="setVolume",n.moduleName=r,v.printOutErrorMessageToConsole(n,o)}},H=function(){return n},U=function(){return r},L=function(){return o},T=function(e){var t="dash",o=[],n="";try{switch(o=e.split("."),n=o.pop().toLowerCase()){case"mp4":t="mp4";break;case"webm":t="webm";break;case"ogg":t="ogg";break;case"mpd":t="dash";break;case"m3u8":t="hls";break;default:t="mp4"}}catch(a){var s={};s.message="Could not determine stream type, check videoUrl as input",s.methodName="returnStreamTypeBasedOnVideoUrl",s.moduleName=r,v.printOutErrorMessageToConsole(s,a)}return t},W=function(){try{var e=document.querySelectorAll("."+u.videoWrapperClassName)[0];try{var t=e.getElementsByTagName("video")[0];t.src=""}catch(o){}e.innerHTML=""}catch(o){var n={};n.message="Could not clear videoElement from videoWrapper, checkt accessibility in DOM",n.methodName="clearVideoContainer",n.moduleName=r,v.printOutErrorMessageToConsole(n,o)}},F=function(){m.subtitleTracksArray=[],m.adaptiveStreamBitrateObjectMap.clear(),m.currentVideoBaseUrl="auto"},B=function(){F(),W(),f&&(f.abortSourceBuffers(),f.clearMediaSource(),f.clearCurrentVideoStreamObject())},R=function(){S(function(e){c.subtitleLanguageObject=JSON.parse(e)||[]})},A=function(){if(u.debugMode){var e={};e.message="Started "+r+" with version: "+n,e.methodName="printStartMessageToConsole",e.moduleName=r,e.moduleVersion=n,v.printOutMessageToConsole(e)}};return t.load=C,t.pause=y,t.play=V,t.seek=j,t.setVolume=E,t.fullscreen=M,t.getName=U,t.getVersion=H,t.isModule=L,t.getArrayOfSubtitleObjects=O,R(),A(),t};