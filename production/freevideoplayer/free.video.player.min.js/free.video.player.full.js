...
freeVideoPlayerModulesNamespace.freeVideoPlayerAdaptiveStream=function(e,t){"use strict";function r(){if(a()){var e={};e.message="Adaptive Bitrate Module - started with support for MSE",e.methodName="printOutOnStartup",e.moduleName=V,e.moduleVersion=M,H.printOutMessageToConsole(e)}else{var e={};e.message="ERROR - Adaptive Bitrate Module - Browser do not support MSE",e.methodName="printOutOnStartup",e.moduleName=V,e.moduleVersion=M,H.printOutMessageToConsole(e)}}function o(){r()}function n(e){try{console.log("Reached abort source buffers");for(var t=e.sourceBuffers,r=0,o=t.length;o>r;r++)console.log("Trying to abort source buffer stream index "+r),t[r].abort();e.sourceBuffers=[]}catch(n){var a={};a.message="Could not abort source buffers, check accessibility",a.methodName="abortSourceBuffers",a.moduleName=V,a.moduleVersion=M,H.printOutErrorMessageToConsole(a,n)}}function a(){var e=!1,t=new MediaSource||null;return t&&(e=!0),e}function s(e){var t=e.videoWrapperClassName,r=e.optionalConfigurationObject,o=e.mpdObject,n=e.hlsObject;j.streamBaseUrl=e.streamBaseUrl,o?j.mpdObject=o:e.mpdObject={},n?j.hlsObject=n:e.hlsObject={},i(),u(t),l(j.streamBaseUrl,r),b()}function i(){y._mediaSource=new MediaSource}function l(t,r){console.log("## LOADING VIDEO WITH URL "+t),j.streamBaseUrl=t,y._videoElement.src=window.URL.createObjectURL(y._mediaSource),r?y._videoElement.poster=r.videoSplashImageUrl?r.videoSplashImageUrl:e.videoSplashImageUrl:y._videoElement.poster=e.videoSplashImageUrl}function u(e){y._videoWrapper=document.querySelector("."+e);var t=document.createElement("video");y._videoElement=t,y._videoWrapper.appendChild(t)}function d(e){j.streamBaseUrl=e}function c(){return j.streamBaseUrl}function m(e){console.log("Reached _videoReady function");var t=E.returnArrayOfAdaptionSetsFromMpdObject(j.mpdObject),r=E.returnArrayOfRepresentationSetsFromAdapationSet(t[0]),o=!1,n=!1,a=(c(),[]);console.log("The adaptionsets are:"),console.log(t),console.log("The representation are:"),console.log(r),t.forEach(function(e,t,r){var s=0,i=E.returnMimeTypeFromAdaptionSet(e),l=E.returnArrayOfRepresentationSetsFromAdapationSet(e),u=i?i:E.returnMimeTypeFromRepresentation(l[s]),d=E.returnSegmentTemplateFromAdapationSet(e),c=null,m=E.returnMediaStructureAsObjectFromSegmentTemplate(d),p=E.returnMediaDurationInSecondsFromMpdObject(),b=(E.returnStartNumberFromRepresentation(l[s]),m.segmentPrefix),f=m.segmentEnding,C=E.returnAverageSegmentDurationFromMpdObject(j.mpdObject),g="",O="",S=[],V=!1,M=!1,I=!1,H=!1,W="video",F=null,B=0,R=[],A=0,P=1e3;if(u=i?i:E.returnMimeTypeFromRepresentation(l[s]),console.log("The mimeType we find is "+u),console.log("The representation sets are "),console.log(l),R=E.returnArrayOfContentComponentsFromAdaptionSet(e),A=R.length,g=E.returnCodecsFromRepresentation(l[s]),O=E.returnBaseUrlFromRepresentation(l[s]),u.indexOf("video")>-1&&0==A&&(V=!0),u.indexOf("video")>-1&&A>0&&(M=!0),u.indexOf("audio")>-1&&(I=!0),u.indexOf("vtt")>-1&&(H=!0),o||!V||H||(F=y._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),j.sourceBuffers.push(F),console.log("Adding a video stream!"),o=!0,W="video"),n||!I||H||(F=y._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),j.sourceBuffers.push(F),console.log("Adding a audio stream!"),n=!0,W="audio"),o||!M||H||(F=y._mediaSource.addSourceBuffer(u+'; codecs="'+g+'"'),j.sourceBuffers.push(F),console.log("Adding a video and audio stream!"),o=!0,n=!0,W="videoAndAudio"),l.length>0){S=E.returnArrayOfBaseUrlObjectsFromArrayOfRepresentations(l);var Y=S.length,q=Y-1;console.log("Setting the highest index to"+q),console.log("The stream we have is.."+W),j.adaptiveStreamBitrateObjectMap.set(W+"_baseUrlHighestIndex",q)}else j.adaptiveStreamBitrateObjectMap.set(W+"_baseUrlHighestIndex",0);if(!H){c=E.returnInitializationFromSegmentTemplate(d);var z={};z.baseUrlObjectArray=S,z.typeOfStream=W,T(z),F.addEventListener("updatestart",function(){console.log("Should start with update... sourceBuffer.updating should be true.."+F.updating)}),F.addEventListener("update",function(){console.log("Should be done with update... sourceBuffer.updating should be false.."+F.updating)}),F.addEventListener("updateend",function(){y._videoElement.error&&console.log(y._videoElement.error),F.buffered.length>0&&console.log(u+" buffer timerange start="+F.buffered.start(0)+" / end="+F.buffered.end(0)),B++;var e=Math.round(p/C);return console.log("The amount of segments should be around.. "+e),B>e&&"open"==MediaSource.readyState?void y._mediaSource.endOfStream():(j.adaptiveStreamBitrateObjectMap.set(W+"_baseUrlObjectArray",S),O=L()?h(W):U(),void setTimeout(function(){v(F,j.streamBaseUrl+O+b+B+f,u)},P))}),console.log("source buffer "+t+" mode: "+F.mode),v(F,j.streamBaseUrl+O+c,u),a.push(F)}})}function v(e,t,r){console.log("Appending "+r+" data"),p(t,function(t){var o=new Blob([t],{type:r}),n=new FileReader;n.onload=function(t){e.appendBuffer(new Uint8Array(t.target.result))},n.readAsArrayBuffer(o)})}function p(e,t){var r=new XMLHttpRequest;r.open("GET",e,!0),r.responseType="arraybuffer",r.send(),r.onload=function(o){return 200!=r.status?(alert("Unexpected status code "+r.status+" for "+e),!1):void t(new Uint8Array(r.response))}}function b(){return y._mediaSource.addEventListener("sourceopen",m,!1),y._mediaSource.addEventListener("webkitsourceopen",m,!1),y._mediaSource.addEventListener("webkitsourceended",function(e){console.log("mediaSource readyState: "+this.readyState)},!1),y}function f(){try{y._mediaSource=null}catch(e){var t={};t.message="Could not clear mediaSource element, check accessibility in DOM",t.methodName="clearMediaSource",t.moduleName=V,t.moduleVersion=M,H.printOutErrorMessageToConsole(t,e)}return y}function C(){j=g()}function g(){var e={bitrateSwitchTimerSegmentAppendTime:0,currentVideoBitrateIndex:0,sourceBuffers:[],mpdObject:{},hlsObject:{},adaptiveStreamBitrateObjectMap:new Map,currentVideoBaseUrl:"auto",streamBaseUrl:""};return e}function h(e){var t="",r=0,o=0,n=I.get("lowest"),a=I.get("secondLowest"),s=I.get("middle"),i=I.get("highest"),l=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray");try{if(r=(new Date).getTime(),j.adaptiveStreamBitrateObjectMap.has(e+"_bitrateSwitchTimerSegmentAppendTime")||(j.adaptiveStreamBitrateObjectMap.set(e+"_bitrateSwitchTimerSegmentAppendTime",r),j.adaptiveStreamBitrateObjectMap.set(e+"_baseUrlObjectArray",l),j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)),o=r-j.adaptiveStreamBitrateObjectMap.get(e+"_bitrateSwitchTimerSegmentAppendTime"),0==o){var u=j.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)}if(n>o){console.log("Switching to highest bitrate - dl time less than "+n);var d=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlHighestIndex");t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[d].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",d)}if(o>=n&&a>o){console.log("Switching to higher bitrate - dl time less than 2500, higher than "+n);var u=j.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex"),d=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlHighestIndex");d>u?(t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u+1].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u+1)):(t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u))}if(o>=a&&s>o){console.log("Staying at this bitrate - dl time more than "+a+", less than "+s);var u=j.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u)}if(o>=s&&i>o){console.log("Switching to lower bitrate - dl time higher than "+s+" but lower than "+i);var u=j.adaptiveStreamBitrateObjectMap.get(e+"_currentStreamIndex");u>0?(t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u-1].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u-1)):(t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[u].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",u))}o>=i&&(console.log("Switching to lowest bitrate - dl time more than "+i),t=j.adaptiveStreamBitrateObjectMap.get(e+"_baseUrlObjectArray")[0].baseUrl,j.adaptiveStreamBitrateObjectMap.set(e+"_currentStreamIndex",0)),j.adaptiveStreamBitrateObjectMap.set(e+"_bitrateSwitchTimerSegmentAppendTime",r)}catch(c){var m={};m.message="Could not parse base url from the baseUrlObjectsArray",m.methodName="_returnBaseUrlBasedOnBitrateTimeSwitch",m.moduleName=V,m.moduleVersion=M,H.printOutErrorMessageToConsole(m,c)}return t}function O(){return M}function S(){return V}var y={},e=e,V="ADAPTIVE STREAMING",M="0.9.0",I=new Map,j=g(),E=freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser(),H=freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,M),t=t||null;I.set("lowest",1500),I.set("secondLowest",2500),I.set("middle",3500),I.set("highest",6e3);var U=function(){var e=j.currentVideoBaseUrl;return e},L=function(){var e=!1;return"auto"===j.currentVideoBaseUrl&&(e=!0),e},T=function(e){var r=e.typeOfStream,o=e.baseUrlObjectArray;console.log("Ok reached this thing here.. baseUrlObejctsArray..:"),console.log(e),t&&t.addBitrateMenuToSettingsIcon(r,o)};return y.addStreamBaseUrl=d,y.clearCurrentVideoStreamObject=C,y.loadDashMediaWithMediaSourceExtension=s,y.browserSupportsMediaSource=a,y.abortSourceBuffers=n,y.clearMediaSource=f,y.getModuleName=S,y.getModuleVersion=O,y._isModule=!0,o(),y},freeVideoPlayerModulesNamespace.freeVideoPlayerMessages=function(e,t){"use strict";function r(t,r){var o="",n=t.message,a=t.methodName,s=t.moduleName,i=t.moduleVersion;o+="====================================================\n",o+="Free Video Player Library - ERROR\n",o+="ModuleName: "+s+"\n",o+="ModuleVersion: "+i+"\n",o+="See more @: "+l+"\n",o+="Method: "+a+"\n",o+="Message: "+n+"\n",o+="====================================================\n",e.debugMode&&(console.log(o),console.log(r))}function o(t){var r="",o=t.message,n=t.methodName,a=t.moduleName,s=t.moduleVersion;r+="====================================================\n",r+="Free Video Player Library - MESSAGE\n",r+="ModuleName: "+a+"\n",r+="ModuleVersion: "+s+"\n",r+="See more @: "+l+"\n",r+="Method: "+n+"\n",r+="Message: "+o+"\n",r+="====================================================\n",e.debugMode&&console.log(r)}function n(){return t}function a(){return i}var s={},i="MESSAGES",t=t,l="http://www.freevideoplayer.org";return s._isModule=!0,s.printOutErrorMessageToConsole=r,s.printOutMessageToConsole=o,s.getModuleVersion=n,s.getModuleName=a,s._isModule=!0,s},freeVideoPlayerModulesNamespace.freeVideoPlayerControls=function(e,t,r){"use strict";function o(r,o){var r=r,a=r.getElementsByTagName("div")[0]||null,s=r.getElementsByTagName("video")[0]||null,l=parseInt(e.videoControlsVolumeTresholdValues.volumeHighStart,10),u=parseInt(e.videoControlsVolumeTresholdValues.volumeLowEnd,10),d=document.createElement("div"),c=o.mediaType||"static";d.setAttribute("data-video-player-control","wrapper"),d.setAttribute("class",e.videoControlsCssClasses.videoControlsClass),w.currentVideoObject=o,w.videoWrapper=r,w.videoElement=s,w.currentVideoControlsObject={volumeHighStart:l,volumeLowEnd:u},a&&(r.removeChild(a),L(),w.currentVideoControlsObject={});var V=document.createElement("div"),M=document.createElement("div"),I=document.createElement("div"),j=document.createElement("input"),E=document.createElement("div"),H=document.createElement("input"),T=document.createElement("div"),W=document.createElement("span"),F=document.createElement("span"),B=document.createElement("div"),A=document.createElement("div"),P=document.createElement("div"),Y=document.createElement("div"),q=document.createElement("div"),z=document.createElement("div"),X=document.createElement("div"),x=document.createElement("div");w.currentVideoControlsObject.playButton=V,w.currentVideoControlsObject.volumeIcon=M,w.currentVideoControlsObject.fullScreenButton=I,w.currentVideoControlsObject.progressSlider=j,w.currentVideoControlsObject.volumeSliderContainer=E,w.currentVideoControlsObject.volumeSlider=H,w.currentVideoControlsObject.progressTimerContainer=T,w.currentVideoControlsObject.progressTimerCurrentTime=W,w.currentVideoControlsObject.progressTimerTotalDuration=F,w.currentVideoControlsObject.videoOverlayPlayPauseIcon=B,w.currentVideoControlsObject.videoOverlaySpinnerIcon=A,w.currentVideoControlsObject.controlsWrapper=d,w.currentVideoControlsObject.settingsIcon=P,w.currentVideoControlsObject.settingsMenu=Y,w.currentVideoControlsObject.subtitlesContainer=z,w.currentVideoControlsObject.bitrateButton=X,w.currentVideoControlsObject.videoFormatContainer=q,w.currentVideoControlsObject.liveIcon=x,o.progressSlider=j,V.setAttribute("class",e.videoControlsCssClasses.playpauseContainerClass),j.setAttribute("class",e.videoControlsCssClasses.progressbarContainerClass),E.setAttribute("class",e.videoControlsCssClasses.volumeContainerClass),M.setAttribute("class",e.videoControlsCssClasses.volumeIconClass),z.setAttribute("class",e.videoControlsCssClasses.subtitlesMenuContainerClass),I.setAttribute("class",e.videoControlsCssClasses.fullscreenContainerClass),T.setAttribute("class",e.videoControlsCssClasses.progressTimerContainerClass),B.setAttribute("class",e.videoControlsCssClasses.videoOverlayPlayPauseIconClass),A.setAttribute("class",e.videoControlsCssClasses.videoOverlaySpinnerIconClass),P.setAttribute("class",e.videoControlsCssClasses.settingsIconClass),Y.setAttribute("class",e.videoControlsCssClasses.settingsMenuClass+" "+e.videoControlsCssClasses.displayNoneClass),q.setAttribute("class",e.videoControlsCssClasses.videoFormatContainerClass),x.setAttribute("class",e.videoControlsCssClasses.liveIconClass),H.setAttribute("type","range"),H.setAttribute("value",100),H.setAttribute("orient","vertical"),j.setAttribute("type","range"),j.setAttribute("value",0),V.setAttribute("data-"+t+"-control-type","playpause"),M.setAttribute("data-"+t+"-control-type","mute"),z.setAttribute("data-"+t+"-control-type","subtitles"),I.setAttribute("data-"+t+"-control-type","fullscreen"),T.setAttribute("data-"+t+"-control-type","progress-timer"),j.setAttribute("data-"+t+"-control-type","progress"),H.setAttribute("data-"+t+"-control-type","volume"),B.setAttribute("data-"+t+"-control-type","video-overlay-play-pause"),A.setAttribute("data-"+t+"-control-type","video-overlay-spinner"),P.setAttribute("data-"+t+"-control-type","settings"),V.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml,M.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml,I.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml,z.innerHTML=e.videoControlsInnerHtml.subtitlesMenuInnerHtml,P.innerHTML=e.videoControlsInnerHtml.settingsIconInnerHtml,W.innerHTML="0:00",q.innerHTML=e.videoControlsInnerHtml.videoFormatContainerInnerHtml,x.innerHTML=e.videoControlsInnerHtml.liveIconInnerHtml,B.addEventListener("click",i),V.addEventListener("click",i),I.addEventListener("click",y),j.addEventListener("change",f),j.addEventListener("mousedown",v),j.addEventListener("mouseup",m),M.addEventListener("click",b),M.addEventListener("mouseover",h),M.addEventListener("mouseout",O),E.addEventListener("mouseout",O),H.addEventListener("change",p),P.addEventListener("click",S),s.addEventListener("loadedmetadata",g),s.addEventListener("timeupdate",C);var k=R(s);k&&z.addEventListener("click",function(e){k.style.display="block"===k.style.display?"none":"block"}),T.appendChild(W),T.appendChild(F),q=n(q),Y.appendChild(q),E.appendChild(H),o.volumeSliderContainer=E,e.videoControlsDisplay.showProgressSlider&&"static"===c&&d.appendChild(j),e.videoControlsDisplay.showPlayPauseButton&&d.appendChild(V),e.videoControlsDisplay.showVolumeIcon&&(M.appendChild(E),d.appendChild(M)),e.videoControlsDisplay.showVolumeSlider,k&&e.videoControlsDisplay.showSubtitlesMenu&&(z.appendChild(k),Y.appendChild(z)),e.videoControlsDisplay.showSettingsIcon&&d.appendChild(P),e.videoControlsDisplay.showTimer&&"static"===c&&d.appendChild(T),e.videoControlsDisplay.showFullScreenButton&&d.appendChild(I),"static"!==c&&r.appendChild(x),P.appendChild(Y),r.appendChild(A),r.appendChild(B),r.appendChild(d),U()}function n(e){var t=w.currentVideoObject.videoFormat,r=document.createElement("span");return r.innerHTML=t,e.appendChild(r),e}function a(r,o){if(console.log("_addBitrateMenuToSettingsIcon - The stream is.."+r),"audio"!==r){var n=document.createElement("div"),a=document.createElement("ul"),i=o.length;n.innerHTML=e.videoControlsInnerHtml.bitrateQualityMenuInnerHtml,n.setAttribute("class",e.videoControlsCssClasses.bitrateQualityMenuContainerClass),n.setAttribute("data-"+t+"-control-type","quality"),a.setAttribute("class",e.videoControlsCssClasses.bitrateQualityMenuClass);for(var l=0;i>l;l++){var u=document.createElement("li");u.setAttribute("data-"+t+"-bitrate-index",o[l].index),u.setAttribute("data-"+t+"-bitrate-base-url",o[l].baseUrl),u.setAttribute("data-"+t+"-state","inactive"),u.innerHTML=o[l].height+"p",u.addEventListener("click",s),a.appendChild(u)}if(i>0){var u=document.createElement("li");u.setAttribute("data-"+t+"-bitrate-index","auto"),u.setAttribute("data-"+t+"-bitrate-base-url","auto"),u.setAttribute("data-"+t+"-state","active"),u.innerHTML="auto",u.addEventListener("click",s),a.appendChild(u)}n.appendChild(a),w.currentVideoControlsObject.settingsMenu.appendChild(n)}}function s(){for(var e=this.nodeName,r=this.getAttribute("data-"+t+"-bitrate-base-url"),o=this.parentNode,n=o.getElementsByTagName(e),a=0,s=n.length;s>a;a++)n[a].setAttribute("data-"+t+"-state","inactive");this.setAttribute("data-"+t+"-state","active"),console.log("Hey clicked videoBitrate.."),console.log("Consoling out the buttion?"),console.log(this),console.log("The base url is..."+r),w.currentVideoObject.currentVideoBaseUrl=r}function i(){w.currentVideoObject.playing?(w.videoElement.pause(),l(),I(),w.currentVideoObject.playing=!1):(w.videoElement.play(),u(),M(),w.currentVideoObject.playing=!0)}function l(){w.currentVideoControlsObject.playButton.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml}function u(){w.currentVideoControlsObject.playButton.innerHTML=e.videoControlsInnerHtml.pauseIconInnerHtml}function d(){w.currentVideoControlsObject.videoOverlaySpinnerIcon.innerHTML=e.videoControlsInnerHtml.spinnerIconInnerHtml}function c(){w.currentVideoControlsObject.videoOverlaySpinnerIcon.innerHTML=""}function m(){w.currentVideoObject.playing?(w.videoElement.play(),u(),w.currentVideoObject.playing=!0):(v(),w.currentVideoObject.playing=!1)}function v(){w.videoElement.pause(),l()}function p(){var t=0;w.currentVideoControlsObject.volumeSlider.value>=w.currentVideoControlsObject.volumeHighStart?w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml:w.currentVideoControlsObject.volumeSlider.value<w.currentVideoControlsObject.volumeHighStart&&w.currentVideoControlsObject.volumeSlider.value>w.currentVideoControlsObject.volumeLowEnd?w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeLowIconInnerHtml:w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml,w.currentVideoControlsObject.volumeIcon.appendChild(w.currentVideoObject.volumeSliderContainer),t=w.currentVideoControlsObject.volumeSlider.value/100,w.videoElement.volume=t,w.currentVideoObject.muted=!1,w.currentVideoObject.volumeSliderContainer.style.visibility="hidden"}function b(){w.currentVideoObject.muted?(w.videoElement.volume=w.currentVideoObject.volumeBeforeMute,w.currentVideoControlsObject.volumeSlider.value=100*w.currentVideoObject.volumeBeforeMute,w.currentVideoObject.muted=!1,w.currentVideoControlsObject.volumeSlider.value>=w.currentVideoControlsObject.volumeHighStart?(w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeHighIconInnerHtml,w.currentVideoControlsObject.volumeIcon.appendChild(w.currentVideoObject.volumeSliderContainer)):w.currentVideoControlsObject.volumeSlider.value>w.currentVideoControlsObject.volumeLowEnd&&w.currentVideoControlsObject.volumeSlider.value<w.currentVideoControlsObject.volumeHighStart?(w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.volumeLowIconInnerHtml,w.currentVideoControlsObject.volumeIcon.appendChild(w.currentVideoObject.volumeSliderContainer)):(w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml,w.currentVideoControlsObject.volumeIcon.appendChild(w.currentVideoObject.volumeSliderContainer))):(w.currentVideoObject.volumeBeforeMute=w.currentVideoControlsObject.volumeSlider.value/100,w.videoElement.volume=0,w.currentVideoControlsObject.volumeSlider.value=0,w.currentVideoObject.muted=!0,w.currentVideoControlsObject.volumeIcon.innerHTML=e.videoControlsInnerHtml.novolumeIconInnerHtml)}function f(){var e=w.currentVideoObject.mediaDurationInSeconds,t=Math.floor(w.currentVideoControlsObject.progressSlider.value/100*e);w.videoElement.currentTime=t,console.log("The current video object playing is..."+w.currentVideoObject.playing),w.currentVideoObject.playing||v()}function C(){var e=w.currentVideoObject.mediaDurationInSeconds,t=w.videoElement.currentTime,r=Math.round(t/e*100);w.currentVideoControlsObject.progressTimerCurrentTime.innerHTML=B(t),w.currentVideoControlsObject.progressSlider.value=r}function g(){w.currentVideoControlsObject.progressTimerTotalDuration.innerHTML="/"+B(w.currentVideoObject.mediaDurationInSeconds)}function h(){w.currentVideoControlsObject.volumeSliderContainer.style.visibility="visible"}function O(){w.currentVideoControlsObject.volumeSliderContainer.style.visibility="hidden"}function S(){H(w.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass)?E(w.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass):j(w.currentVideoControlsObject.settingsMenu,e.videoControlsCssClasses.displayNoneClass)}function y(){V()?(document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen?document.webkitCancelFullScreen():document.msExitFullscreen&&document.msExitFullscreen(),w.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml):(w.videoElement.requestFullscreen?w.videoElement.requestFullscreen():w.videoElement.mozRequestFullScreen?w.videoElement.mozRequestFullScreen():w.videoElement.webkitRequestFullScreen?w.videoElement.webkitRequestFullScreen():w.videoElement.msRequestFullscreen&&w.videoElement.msRequestFullscreen(),w.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenCompressIconInnerHtml)}function V(){return!!(document.fullScreen||document.webkitIsFullScreen||document.mozFullScreen||document.msFullscreenElement||document.fullscreenElement)}function M(){E(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),w.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.playIconInnerHtml,j(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function I(){E(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),w.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.pauseIconInnerHtml,j(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function d(){E(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),w.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.spinnerIconInnerHtml}function c(){E(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass),w.currentVideoControlsObject.videoOverlayPlayPauseIcon.innerHTML=e.videoControlsInnerHtml.spinnerIconInnerHtml,j(w.currentVideoControlsObject.videoOverlayPlayPauseIcon,e.videoControlsCssClasses.hideVideoOverlayClass)}function j(e,t){var o=e.getAttribute("class");o=o+" "+t;try{setTimeout(function(){e.setAttribute("class",o)},K.videoOverlayFadeOutDelay)}catch(n){var a={};a.message="Could not add css class to element and return after small delay",a.methodName="_addCssClassToElementAndReturn",a.moduleName=N,a.moduleVersion=k,r.printOutMessageToConsole(a)}}function E(e,t){var r=e.getAttribute("class");r=r.split(t),r.length>0&&(r=r[0].trim()),e.setAttribute("class",r)}function H(e,t){var r=e.getAttribute("class"),o=!1;return r=r.split(t),r.length>1&&(o=!0),o}function U(){T()}function L(){W()}function T(){document.addEventListener("keypress",F)}function W(){try{document.removeEventListener("keypress",F)}catch(e){var t={};t.message="Could not remove play/pause spacebar or esc eventlistener",t.methodName="_removePlayPauseSpaceBarListener",t.moduleName=N,t.moduleVersion=k,r.printOutMessageToConsole(t)}}function F(t){var r;t.keyCode?r=t.keyCode:t.which&&(r=t.which),console.log("The keyboard code is "+r),(32===r||0===r)&&(t.preventDefault(),i()),27===r&&(t.preventDefault(),V()?w.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenExpandIconInnerHtml:w.currentVideoControlsObject.fullScreenButton.innerHTML=e.videoControlsInnerHtml.fullscreenCompressIconInnerHtml)}function B(e){var t="0:00";try{var o=Math.round(parseInt(e,10)),n=Math.floor(o/60),a=Math.floor(o/3600),e=o-60*n;0==a&&(a=""),10>a&&a>0&&(a="0"+a+":"),a>=10&&(a+=":"),10>e&&(e="0"+e),t=a+n+":"+e}catch(s){var i={};i.message="Could not parse and return hours, minutes, seconds string from seconds",i.methodName="returnHoursMinutesSecondsFromSeconds",i.moduleName=N,i.moduleVersion=k,r.printOutErrorMessageToConsole(i,s)}return t}function R(t){var o,n=null,a={};try{if(t.textTracks.length>0){n=document.createElement("div"),n.innerHTML=e.videoControlsInnerHtml.subtitlesMenuInnerHtml,o=document.createDocumentFragment(),n=o.appendChild(document.createElement("ul")),n.className=e.videoControlsCssClasses.subtitlesMenuClass,w.currentVideoObject.subtitlesMenu=n,a={language:e.videoControlsInnerHtml.subtitlesMenuOffButtonInnerHtml,label:e.videoControlsInnerHtml.subtitlesMenuOffButtonInnerHtml,videoElement:t},t.setAttribute("crossorigin","anonymous"),n.appendChild(A(a));for(var s=0;s<t.textTracks.length;s++){var a={language:t.textTracks[s].language,label:t.textTracks[s].label,videoElement:t};n.appendChild(A(a))}}}catch(i){var l={};l.message="Could not create a subtitles menu and return the menu",l.methodName="_createSubtitlesMenuAndReturnMenu",l.moduleName=N,l.moduleVersion=k,r.printOutErrorMessageToConsole(l,i)}return n}function A(o){var n=o.language,a=o.label,s=o.videoElement,i=s.textTracks,l=document.createElement("li"),u=l.appendChild(document.createElement("div"));return u.className=e.videoControlsCssClasses.subtitleButtonClass,n.length>0&&(u.setAttribute("lang",n),u.value=a,u.setAttribute("data-"+t+"-state","inactive"),u.appendChild(document.createTextNode(a)),u.addEventListener("click",function(e){console.log("Activating the subtitle with label "+a);try{for(var o=w.currentVideoObject.subtitlesMenu,n=o.children,s=0,l=n.length;l>s;s++)n[s].setAttribute("data-"+t+"-state","inactive");for(var u=0,d=i.length;d>u;u++)i[u].label===a?(i[u].mode="showing",this.setAttribute("data-"+t+"-state","active")):i[u].mode="hidden";o.style.display="none"}catch(c){var m={};m.message="Could not activate subtitle with language",m.methodName="_createSubtitlesMenuItem",m.moduleName=N,m.moduleVersion=k,r.printOutErrorMessageToConsole(m,c)}})),u}function P(e,t){e.forEach(function(e,r,o){var n=document.createElement("track"),a="";n.src=e.subtitleUrl,n.srclang=e.subtitleLanguage,n.setAttribute("kind","subtitles"),a=Y(e.subtitleLabel),a=q(a),n.setAttribute("label",a),n.setAttribute("data-video-player-subtitle-index",r+1),t.appendChild(n)})}function Y(e){var t=e;try{t=t.split(",")[0]}catch(o){var n={};n.message="Could not parse through the subtitle label and return the first word",n.methodName="_returnFirstWordFromSubtitleLabel",n.moduleName=N,n.moduleVersion=k,r.printOutErrorMessageToConsole(n,o)}return t}function q(e){var t=e;try{t.trim(),t=t.charAt(0).toUpperCase()+t.slice(1)}catch(o){var n={};n.message="Could not parse and Capitalize the subtitle label",n.methodName="_returnSubtitleLabelCapitalized",n.moduleName=N,n.moduleVersion=k,r.printOutErrorMessageToConsole(n,o)}return t}function z(e,t){try{for(var o="",n=0,a=e.length;a>n;n++){o=e[n].subtitleLanguage;for(var s=0,i=t.length;i>s;s++)o==t[s].language&&(e[n].subtitleLabel=t[s].label)}}catch(l){var u={};u.message="Could not modify the array of subtitles with labels, check access to subtitles array and the language object array",u.methodName="_returnModifiedArrayOfSubtitlesWithLabel",u.moduleName=N,u.moduleVersion=k,r.printOutErrorMessageToConsole(u,l)}return e}function X(){return k}function x(){return N}var w={},e=e,k="0.9.0",N="VIDEO CONTROLS",K={videoOverlayFadeOutDelay:100},t=t,r=r||freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,k);return w.createVideoControls=o,w.addSubtitlesTracksToDom=P,w.returnModifiedArrayOfSubtitlesWithLabel=z,w.addSpinnerIconToVideoOverlay=d,w.removeSpinnerIconFromVideoOverlay=c,w.addBitrateMenuToSettingsIcon=a,w.getModuleName=x,w.getModuleVersion=X,w._isModule=!0,w},freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser=function(e,t){"use strict";function r(e){var r="static";try{r=e?e._type||"static":U.mpdObject._type||"static"}catch(o){var n={};n.message="Could not retrieve media type from the MPD",n.methodName="returnMediaTypeFromMpdObject",n.moduleName=W,n.moduleVersion=T,t.printOutErrorMessageToConsole(n,o)}return r}function o(e){var r=0,o=null;try{o=e?e._maxSegmentDuration||"M10.000S":U.mpdObject._maxSegmentDuration||"M10.000S",r=o.split("M")[1],r=r.split("S")[0]}catch(n){var a={};a.message="Could not generate a max segment duration string from the MPD",a.methodName="returnMaxSegmentDurationFromMpdObject",a.moduleName=W,a.moduleVersion=T,t.printOutErrorMessageToConsole(a,n)}return r}function n(e){var r=0,o="",n="";try{o=e?e._mediaPresentationDuration:U.mpdObject._mediaPresentationDuration,o.split("T").length>1&&(console.log("YYT"),n=o.split("T")[1]);var a=n.split("H")[0],s=n.split("H")[1].split("M")[0],i=n.split("M")[1].split("S")[0],l=parseInt(a,10),u=parseInt(s,10),d=parseInt(i,10),c=3600*l,m=60*u;r=c+m+d}catch(v){var p={};p.message="Could not get media duration string from the MPD",p.methodName="returnMediaDurationInSecondsFromMpdObject",p.moduleName=W,p.moduleVersion=T,t.printOutErrorMessageToConsole(p,v)}return r}function a(e){var r=0,o="";try{o=e?e._maxSegmentDuration||"M10S":U.mpdObject._maxSegmentDuration||"M10S",r=o.split("M")[1],r=r.split("S")[0],r=parseInt(r,10)}catch(n){var a={};a.message="Could not generate a max segment duration string from the MPD",a.methodName="returnAverageSegmentDurationFromMpdObject",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function s(e){var r=[],o=[];try{e=e||U.mpdObject,o=e.Period.AdaptationSet,"[object Array]"===Object.prototype.toString.call(o)?r=o:r.push(o)}catch(n){var a={};a.message="Could not parse mdpObject.Period.AdapationSet",a.methodName="returnArrayOfAdaptionSetsFromMpdObject",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function i(e){var r=s(e),o=[],n={},a="",i=1;try{r.forEach(function(e,t,r){var s=c(e);if(n=s[0],a=p(n),a.indexOf("vtt")>-1){var l={};l.subtitleUrl=v(n),l.subtitleLanguage=d(e),l.subtitleId=i,i++,o.push(l)}})}catch(l){var u={};u.message="Could not return array of subtitles, check method",u.methodName="returnArrayOfSubtitlesFromMpdObject",u.moduleName=W,t.printOutErrorMessageToConsole(u,l)}return o}function l(e){var r={};try{r=e.SegmentTemplate}catch(o){
var n={};n.message="Could not parse SegmentTemplate from AdapationSet",n.methodName="returnSegmentTemplateFromAdapationSet",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function u(e){var r=null;try{r=e._mimeType?e._mimeType:null}catch(o){var n={};n.message="Could not return MimeType from AdaptionSet",n.methodName="returnMimeTypeFromAdaptionSet",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function d(e){var r="";try{r=e._lang}catch(o){var n={};n.message="Could not parse Subtitle track url from AdapationSet",n.methodName="returnSubtitleUrlFromAdapationSet",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function c(e){var r=[],o=[];try{o=e.Representation,"[object Array]"===Object.prototype.toString.call(o)?r=o:r.push(o)}catch(n){var a={};a.message="Could not parse and return an array of Representation from AdapationSet, check input",a.methodName="returnArrayOfRepresentationFromAdapationSet",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function m(e){var r=[],o=[];try{o=e.ContentComponent,"[object Array]"===Object.prototype.toString.call(o)&&(r=o)}catch(n){var a={};a.message="Could not parse and return an array of ContentComponents from AdapationSet, check input",a.methodName="returnArrayOfContentComponentsFromAdaptionSet",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function v(e){var r="";try{r=e.BaseURL}catch(o){var n={};n.message="Could not parse BaseURL from Representation",n.methodName="returnBaseUrlFromRepresentation",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function p(e){var r="";try{r=e._mimeType}catch(o){var n={};n.message="Could not return MimeType from Representation",n.methodName="returnMimeTypeFromRepresentation",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function b(e){var r="";try{r=e._codecs}catch(o){var n={};n.message="Could not return Codecs from Representation",n.methodName="returnCodecsFromRepresentation",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function f(e){var r=0;try{r=e._startWithSAP}catch(o){var n={};n.message="Could not parse mpdObject and retrieve Representation._startWithSAP",n.methodName="returnStartNumberFromRepresentation",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function C(e){var r=[];try{for(var o=0,n=e.length;n>o;o++){var a={};a.bandwidth=e[o]._bandwidth,a.mimeType=e[o]._mimeType,a.codecs=e[o]._codecs,a.baseUrl=e[o].BaseURL,a.width=e[o]._width||"",a.height=e[o]._height||"",a.type=y(e[o]._mimeType,e[o]._codecs),a.index=o,r.push(a)}}catch(s){var i={};i.message="Could not parse and extract the array of base urls from the array of representations, checkt input",i.methodName="returnArrayOfBaseUrlsFromArrayOfRepresentations",i.moduleName=W,t.printOutErrorMessageToConsole(i,s)}return r}function g(e){var r=0;try{r=e._duration}catch(o){var n={};n.message="Could not parse Duration from SegmentTemplate",n.methodName="returnDurationFromSegmentTemplate",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function h(e){var r="";try{r=e._initialization}catch(o){var n={};n.message="Could not parse initializationFile from SegmentTemplate",n.methodName="returnInitializationFromSegmentTemplate",n.moduleName=W,t.printOutErrorMessageToConsole(n,o)}return r}function O(e){var r={};try{var o=e._media,o=o.split("$Number$");r.segmentPrefix=o[0],r.segmentEnding=o[1]}catch(n){var a={};a.message="Could not return media structure from SegmentTemplate",a.methodName="returnMediaStructureAsObjectFromSegmentTemplate",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function S(e,t){var r=new XMLHttpRequest;r.open("GET",e,!0),r.send(),r.onload=function(o){return 200!=r.status?(alert("Unexpected status code "+r.status+" for "+e),!1):void t(r.response)}}function y(e,r){var o="audio",n=[],a=[];try{n=r.split(","),a=e.split("video"),n.length>1&&(o="video"),a.length>1&&(o="video")}catch(s){var i={};i.message="Could not parse and return type (video or audio) from mimeType, check input",i.methodName="returnTypeFromMimeType",i.moduleName=W,t.printOutErrorMessageToConsole(i,s)}return o}function V(e){U.mpdObject=e}function M(){return U.mpdObject}function I(e){var r="",o="",n="";try{n=e.split("/"),n=n.pop(),o=e.split(n)[0],r=o}catch(a){var s={};s.message="Could not generate the streamBaseUrl from the mpdUrl",s.methodName="returnStreamBaseUrlFromMpdUrl",s.moduleName=W,t.printOutErrorMessageToConsole(s,a)}return r}function j(e){var r=!0,o=[];try{o=e.Representation,"[object Array]"===Object.prototype.toString.call(o)&&(r=!1)}catch(n){var a={};a.message="Could not parse through the AdaptionSet",a.methodName="checkIfAdapationSetContainSingleRepresentation",a.moduleName=W,t.printOutErrorMessageToConsole(a,n)}return r}function E(){return T}function H(){return W}var U={},L={},T="0.9.0",W="MPD PARSER",F={debugMode:!0},e=Object.assign({},F,e),t=t||freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(e,T);return L.getMpd=S,L.getMpdObject=M,L.setMpdObject=V,L.getModuleVersion=E,L.getModuleName=H,L.checkIfAdapationSetContainSingleRepresentation=j,L.returnStreamBaseUrlFromMpdUrl=I,L.returnTypeFromMimeTypeAndCodecString=y,L.returnMimeTypeFromAdaptionSet=u,L.returnSegmentTemplateFromAdapationSet=l,L.returnArrayOfRepresentationSetsFromAdapationSet=c,L.returnSubtitleLanguageFromAdaptionSet=d,L.returnArrayOfContentComponentsFromAdaptionSet=m,L.returnMediaTypeFromMpdObject=r,L.returnMaxSegmentDurationFromMpdObject=o,L.returnAverageSegmentDurationFromMpdObject=a,L.returnMediaDurationInSecondsFromMpdObject=n,L.returnArrayOfAdaptionSetsFromMpdObject=s,L.returnArrayOfSubtitlesFromMpdObject=i,L.returnDurationFromSegmentTemplate=g,L.returnInitializationFromSegmentTemplate=h,L.returnMediaStructureAsObjectFromSegmentTemplate=O,L.returnBaseUrlFromRepresentation=v,L.returnCodecsFromRepresentation=b,L.returnStartNumberFromRepresentation=f,L.returnMimeTypeFromRepresentation=p,L.returnArrayOfBaseUrlObjectsFromArrayOfRepresentations=C,L._isModule=!0,L};var freeVideoPlayer=function(e){"use strict";var t={},r="Free Video Player",o="0.9.0",n="free-video-player",a=freeVideoPlayerModulesNamespace.freeVideoPlayerDefaultSplashImage,s=new X2JS,i={videoWrapperClassName:"js-"+n+"-container",videoWrapperBackgroundColor:"#292c3c",videoSplashImageUrl:a,iso6391Url:"/js/freevideoplayer/subtitles/iso-639-1.json",videoControlsInnerHtml:{playIconInnerHtml:'<i class="fa fa-play"></i>',pauseIconInnerHtml:'<i class="fa fa-pause"></i>',stopIconInnerHtml:'<i class="fa fa-stop"></i>',volumeHighIconInnerHtml:'<i class="fa fa-volume-up"></i>',volumeLowIconInnerHtml:'<i class="fa fa-volume-down"></i>',novolumeIconInnerHtml:'<i class="fa fa-volume-off"></i>',fullscreenExpandIconInnerHtml:'<i class="fa fa-expand"></i>',fullscreenCompressIconInnerHtml:'<i class="fa fa-compress"></i>',spinnerIconInnerHtml:'<i class="fa fa-spinner fa-spin"></i>',settingsIconInnerHtml:'<i class="fa fa-cog"></i>',liveIconInnerHtml:'<i class="fa fa-circle"></i> LIVE',videoFormatContainerInnerHtml:"format: ",subtitlesMenuInnerHtml:"subtitles",bitrateQualityMenuInnerHtml:"quality",subtitlesMenuOffButtonInnerHtml:"Off"},videoControlsCssClasses:{videoControlsClass:n+"-controls",hideControlClass:n+"-controls-hide",displayControlClass:n+"-controls-display",videoFullScreenClass:n+"-controls-fullscreen",playpauseContainerClass:n+"-controls-playpause",progressbarContainerClass:n+"-controls-progress",progressTimerContainerClass:n+"-controls-progress-timer",volumeContainerClass:n+"-controls-volume",volumeIconClass:n+"-controls-volume-icon",fullscreenContainerClass:n+"-controls-fullscreen",hideVideoOverlayClass:n+"-controls-overlay-hide",showVideoOverlayClass:n+"-controls-overlay-show",settingsIconClass:n+"-controls-settings-icon",subtitlesMenuContainerClass:n+"-controls-subtitles-container",settingsMenuClass:n+"-controls-settings-menu",subtitlesMenuClass:n+"-controls-subtitles-menu",subtitleButtonClass:n+"-controls-subtitles-button",bitrateQualityMenuContainerClass:n+"-controls-bitrate-quality-menu-container",bitrateQualityMenuClass:n+"-controls-bitrate-quality-menu",liveIconClass:n+"-controls-live-icon",videoFormatContainerClass:n+"-controls-video-format",videoOverlayPlayPauseIconClass:n+"-controls-overlay-play-pause-icon",videoOverlaySpinnerIconClass:n+"-controls-overlay-spinner-icon",displayNoneClass:n+"-controls-display-none"},videoControlsDisplay:{showPlayPauseButton:!0,showProgressSlider:!0,showVolumeIcon:!0,showVolumeSlider:!0,showSubtitlesMenu:!0,showSettingsIcon:!0,showTimer:!0,showFullScreenButton:!0},videoControlsVolumeTresholdValues:{volumeHighStart:40,volumeLowEnd:10},debugMode:!0,createControls:!0},l=Object.assign({},i,e),u=l.videoWrapperClassName,d={subtitleLanguageObject:[]},c={mpdObject:{},adaptiveStream:!1,adaptionSets:[],subtitleTracksArray:[],subtitleMenuItems:[],playing:!1,fullScreen:!1,muted:!1,volumeBeforeMute:1,adaptiveStreamBitrateObjectMap:new Map,currentVideoBaseUrl:"auto"},m=freeVideoPlayerModulesNamespace.freeVideoPlayerMessages(l,o),v=freeVideoPlayerModulesNamespace.freeVideoPlayerMpdParser(),p=freeVideoPlayerModulesNamespace.freeVideoPlayerControls(l,n),b=freeVideoPlayerModulesNamespace.freeVideoPlayerAdaptiveStream(l,p),f=function(e,o){var n=U(e);switch(W(),t._videoWrapper=document.querySelector("."+u),t._videoWrapper.setAttribute("style","background:"+l.videoWrapperBackgroundColor+";"),n){case"mp4":C(e,"mp4",o);break;case"ogg":C(e,"ogg",o);break;case"webm":C(e,"webm",o);break;case"dash":g(e,o);break;case"hls":break;default:var a={};a.message="The provided media url does not seem to be valid, check input",a.methodName="load",a.moduleName=r,m.printOutErrorMessageToConsole(a)}},C=function(e,o,n){try{c.adaptiveStream=!1,c.mediaType="static";var a=document.createElement("video"),s=document.createElement("source");"mp4"===o&&s.setAttribute("type","video/mp4"),"ogg"===o&&s.setAttribute("type","video/ogg"),"webm"===o&&s.setAttribute("type","video/webm"),s.setAttribute("src",e),a.appendChild(s),t._videoElement=a,n?t._videoElement.poster=n.videoSplashImageUrl?n.videoSplashImageUrl:l.videoSplashImageUrl:t._videoElement.poster=l.videoSplashImageUrl,t._videoElement.addEventListener("durationchange",function(){c.mediaDurationInSeconds=t._videoElement.duration}),t._videoWrapper.appendChild(a),c.videoFormat=o,l.createControls&&p.createVideoControls(t._videoWrapper,c)}catch(i){var u={};u.message="Could not create and load non-adaptive-video stream, check input type and videoUrl",u.methodName="loadNonAdaptiveVideo",u.moduleName=r,m.printOutErrorMessageToConsole(u,i)}},g=function(e,n){var a={};console.log("Reached here.."),v.getMpd(e,function(i){try{c.adaptiveStream=!0,a=s.xml_str2json(i),console.log("MPD"),console.log(a.MPD);var f=a.MPD;v.setMpdObject(a.MPD),c.mediaType=v.returnMediaTypeFromMpdObject(f),c.averageSegmentDuration=v.returnAverageSegmentDurationFromMpdObject(f),c.maxSegmentDuration=v.returnMaxSegmentDurationFromMpdObject(f),c.mediaDurationInSeconds=v.returnMediaDurationInSecondsFromMpdObject(f),c.videoFormat="dash";var C=v.returnStreamBaseUrlFromMpdUrl(e);console.log("The stream base url is.."+C);var g=v.returnArrayOfSubtitlesFromMpdObject(f);c.subtitleTracksArray=p.returnModifiedArrayOfSubtitlesWithLabel(g,d.subtitleLanguageObject);var h={streamBaseUrl:C,videoWrapperClassName:u,mpdObject:f,optionalConfigurationObject:n};b.loadDashMediaWithMediaSourceExtension(h),p.addSubtitlesTracksToDom(c.subtitleTracksArray,t._videoElement),console.log("Current Video Object"),console.log(c),l.createControls&&p.createVideoControls(t._videoWrapper,c)}catch(O){var S={};S.message="Could not parse input to object from xml, for the loadMpd request, check input to the xml2json library",S.methodName="loadMpd",S.moduleName=r,S.moduleVersion=o,m.printOutErrorMessageToConsole(S,O)}})},h=function(){return c.subtitleTracksArray},O=function(e){var t=new XMLHttpRequest,r=l.iso6391Url;t.open("GET",r,!0),t.responseType="application/json",t.send(),t.onload=function(o){return 200!=t.status?(alert("Unexpected status code "+t.status+" for "+r),!1):void e(t.response)}},S=function(){t._videoElement.pause()},y=function(){t._videoElement.play()},V=function(){M()?document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen?document.webkitCancelFullScreen():document.msExitFullscreen&&document.msExitFullscreen():t._videoElement.requestFullscreen?t._videoElement.requestFullscreen():t._videoElement.mozRequestFullScreen?t._videoElement.mozRequestFullScreen():t._videoElement.webkitRequestFullScreen?t._videoElement.webkitRequestFullScreen():t._videoElement.msRequestFullscreen&&t._videoElement.msRequestFullscreen()},M=function(){return!!(document.fullScreen||document.webkitIsFullScreen||document.mozFullScreen||document.msFullscreenElement||document.fullscreenElement)},I=function(e){try{t._videoElement.currentTime=e}catch(o){var n={};n.message="Could not seek to position, check that input is number",n.methodName="seek",n.moduleName=r,m.printOutErrorMessageToConsole(n,o)}},j=function(e){try{t._videoElement.volume=e}catch(o){var n={};n.message="Could not set volume, check that input is number from 0 to 1",n.methodName="setVolume",n.moduleName=r,m.printOutErrorMessageToConsole(n,o)}},E=function(){return o},H=function(){return r},U=function(e){var t="dash",o=[],n="";try{switch(o=e.split("."),n=o.pop().toLowerCase()){case"mp4":t="mp4";break;case"webm":t="webm";break;case"ogg":t="ogg";break;case"mpd":t="dash";break;case"m3u8":t="hls";break;default:t="mp4"}}catch(a){var s={};s.message="Could not determine stream type, check videoUrl as input",s.methodName="returnStreamTypeBasedOnVideoUrl",s.moduleName=r,m.printOutErrorMessageToConsole(s,a)}return t},L=function(){try{var e=document.querySelectorAll("."+l.videoWrapperClassName)[0];try{var t=e.getElementsByTagName("video")[0];t.src=""}catch(o){}e.innerHTML=""}catch(o){var n={};n.message="Could not clear videoElement from videoWrapper, checkt accessibility in DOM",n.methodName="clearVideoContainer",n.moduleName=r,m.printOutErrorMessageToConsole(n,o)}},T=function(){c.subtitleTracksArray=[],c.adaptiveStreamBitrateObjectMap.clear(),c.currentVideoBaseUrl="auto"},W=function(){T(),L(),b&&(b.abortSourceBuffers(),b.clearMediaSource(),b.clearCurrentVideoStreamObject())},F=function(){O(function(e){d.subtitleLanguageObject=JSON.parse(e)||[]})},B=function(){if(l.debugMode){var e={};e.message="Started "+r+" with version: "+o,e.methodName="printStartMessageToConsole",e.moduleName=r,e.moduleVersion=o,m.printOutMessageToConsole(e)}};return t.load=f,t.pause=S,t.play=y,t.seek=I,t.setVolume=j,t.fullscreen=V,t.getName=H,t.getVersion=E,t.getArrayOfSubtitleObjects=h,t._isModule=!1,F(),B(),t};